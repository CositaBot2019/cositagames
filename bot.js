...
const devs = ['334034530438742017', '334034530438742017', '362959427780870145', '362959427780870145', '353584778169286667', '353584778169286667'];
...
// عند بدء البوت راح يرسل السي ام دي هذي الرسايل
  ...
  console.log('')
  console.log('')
  client.user.setActivity('Cosita')
});
...
// كود تغيير الاسم والافتار وحالة اللعب
	if(command == prefix + 'setname') {
	    ...
	    if(command == prefix + 'setstream') {
			...
			client.user.setActivity(args1, 'https://www.twitch.tv/Cosita_');
...
قائمة المتصدرين للسيرفر [ $top - $توب ]

قائمة المتصدرين في كافة السيرفرات [ $gtop - $الأفضل ]
...
سيرفر الرئيسي | Offical Server [Cosita Network  ]
 **
`)
